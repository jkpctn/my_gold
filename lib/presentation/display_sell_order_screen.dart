...
const TextStyle detailTextnoColor = TextStyle(
  fontSize: 25,
...
class DisplaySellOrderScreen extends StatefulWidget {
  final orders;

  const DisplaySellOrderScreen({Key key, this.orders}) : super(key: key);
  //final data;
  @override
  _DisplaySellOrderScreenState createState() => _DisplaySellOrderScreenState();
}

class _DisplaySellOrderScreenState extends State<DisplaySellOrderScreen> {
  int item = 0;
  double _padding = 20;
  List<SellOrder> tmporders;
  ...
  _navigateAndDisplayEditData(BuildContext context, index) async {
    ...
    final result = await Navigator.of(context)
        .pushNamed(AppRoutes.editSellOrder, arguments: tmporders[index]);
    setState(() {
      if (result != null) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            'ขายออก ${tmporders.length} รายการ',
        ...
        //       onPressed: () => null,
        //       //{Navigator.of(context).pushNamed(AppRoutes.addSellOrder)},
